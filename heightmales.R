...
# do t-tests, get p values and calc mean for the datasets
...
hist(data_without_outliers2, breaks = 20, col = "blue", 
     xlab = "Height", main = "Distribution of data without extra outliers")
abline(v = mu, col = "red", lwd = 2) # mean height
abline(v = mean_without_outliers2, col = "green", lwd = 2) # mean without outliers


# print p vals for the data sets
cat("p-value of t-test on data containing outliers:", p_with_outliers, "\n")
cat("p-value of t-test on data without outliers (MAD * 3):", p_without_outliers, "\n")
cat("p-value of t-test on data without extra outliers (MAD * 2):", p_without_outliers2, "\n")
